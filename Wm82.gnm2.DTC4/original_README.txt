...
Annotation-version = Wm82.a2.v1

All FASTA and GFF3 files are compressed by gzip to reduce the file size for faster downloads.
Note: the number 275 in all file names is a Phytozome internal identifier for the current release of this genome annotation
...
1) Gmax_275_Wm82.a2.v1.annotation_info.txt
...
2) Gmax_275_Wm82.a2.v1.cds.fa.gz and Gmax_275_Wm82.a2.v1.cds_primaryTranscriptOnly.fa.gz
   Nucleotide FASTA format file of all gene coding sequences, with or without alternative splice variants

3) Gmax_275_Wm82.a2.v1.protein.fa.gz and Gmax_275_Wm82.a2.v1.protein_primaryTranscriptOnly.fa.gz
   Amino acid FASTA format file of all gene coding sequences, with or without alternative splice variants

4) Gmax_275_Wm82.a2.v1.transcript.fa.gz and Gmax_275_Wm82.a2.v1.transcript_primaryTranscriptOnly.fa.gz
   Nucleotide FASTA format file of spliced mRNA transcripts (UTR, exons), with or without alternative splice variants

5) Gmax_275_Wm82.a2.v1.gene.gff3.gz
...
6) Gmax_275_Wm82.a2.v1.gene_exons.gff3.gz
...
9) Gmax_275_Wm82.a2.v1.locus_transcript_name_map.txt
   Tab-delimited list of all locus name, transcript name for the Phytozome gene models (column headers in file).

10) Gmax_275_Wm82.a2.v1.repeatmasked_assembly_v2.0.gff3.gz
...
1) Gmax_275_v2.0.fa.gz
   Nucleotide FASTA format of the current genomic assembly

2) Gmax_275_v2.0.softmasked.fa.gz
   Gmax_275_v2.0.hardmasked.fa.gz
